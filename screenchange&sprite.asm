...
backgroundL:
    .dl background00, background01, background02, background03
    .dsb $0C,$00

    .dl background10, background11, background12, background13
    .dsb $0C,$00

    .dl background20, background21, background22, background23
    .dsb $0C,$00

    .dl background30, background31, background32, background33
    .dsb $0C,$00

backgroundH:
    .dh background00, background01, background02, background03
    .dsb $0C,$00

    .dh background10, background11, background12, background13
    .dsb $0C,$00

    .dh background20, background21, background22, background23
    .dsb $0C,$00

    .dh background30, background31, background32, background33
    .dsb $0C,$00
    
attributeL:
    .dl attributes00, attributes01, attributes02, attributes03
    .dsb $0C,$00
    
    .dl attributes10, attributes11, attributes12, attributes13
    .dsb $0C,$00

    .dl attributes20, attributes21, attributes22, attributes23
    .dsb $0C,$00
    
    .dl attributes30, attributes31, attributes32, attributes33
    .dsb $0C,$00

attributeH:
    .dh attributes00, attributes01, attributes02, attributes03
    .dsb $0C,$00
    
    .dh attributes10, attributes11, attributes12, attributes13
    .dsb $0C,$00
    
    .dh attributes20, attributes21, attributes22, attributes23
    .dsb $0C,$00
    
    .dh attributes30, attributes31, attributes32, attributes33
    .dsb $0C,$00
...
attributes00:  ; per byte:  bottom (right-left) <--> top (right-left)
...
attributes01:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%00000000, %00000000,%00000000, %00000000,%00000000
...
attributes02:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%00000000, %00000000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010000, %01010000,%01010000, %01010000,%00010000
...
attributes03:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%00000000, %00000000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010000, %01010000,%01010000, %01010000,%00010000
...
attributes10:  ; per byte:  bottom (right-left) <--> top (right-left)
...
attributes11:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes12:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes13:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes20:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes21:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes22:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes23:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes30:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%00000000, %00000000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes31:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes32:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%01000000, %00010000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010100, %01010001,%01010000, %01010000,%00010000
...
attributes33:  ; per byte:  bottom (right-left) <--> top (right-left)
    .db %00000000,%00000000, %00000000,%00000000, %00000000,%00000000, %00000000,%00000000
    .db %01000000,%01010000, %01010000,%01010000, %01010000,%01010000, %01010000,%00010000
